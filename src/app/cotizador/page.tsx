  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="mx-auto max-w-6xl px-4 py-6">
        <CotizadorForm tipos={data.tipos} recargos={data.recargos} tableros={data.tableros} cantos={data.cantos} trmDefault={data.trmDefault} presetDefault={data.presetDefault} rolesByTipo={data.rolesByTipo} />
      </main>
    </div>
  );
}
