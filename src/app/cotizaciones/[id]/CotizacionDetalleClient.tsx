...
export default function CotizacionDetalleClient({
  cabecera, cocinas, cotizacionId, tipos, recargos, tableros, cantos, presetDefault, rolesByTipo, initialConfig,
}: Props) {
  ...
  return (
    <>
      ...
      {/* Panel de configuración global — colapsable para no estorbar */}
