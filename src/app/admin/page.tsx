...
import { listarCatalogo, getParametros } from '@/lib/admin';
...
export default async function AdminPage() {
  ...
  const [tableros, cantos, herrajes, recargos, parametros] = await Promise.all([
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="mx-auto max-w-6xl px-4 py-6">
        ...
        <AdminCatalogos tableros={tableros} cantos={cantos} herrajes={herrajes} recargos={recargos} parametros={parametros} />
      </main>
    </div>
  );
}
