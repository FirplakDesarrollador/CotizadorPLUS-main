...
export const TIPS_COTIZADOR: Record<string, Info> = {
  ...
  'Nº cajones (override)': { fn: 'Fuerza manualmente el número de cajones.', tip: 'En PCFD, un valor mayor que cero activa el diseño OP y escala bases, traseros y rieles.' },
  'Nº puertas': { fn: 'Fuerza el número de puertas (vacío = automático).', tip: 'Cambia bisagras y manijas del mueble.' },
  'Nº cajones': { fn: 'Fuerza el número de cajones (vacío = automático).', tip: 'En PCFD, un valor mayor que cero activa gavetas ocultas PUSH.' },
  ...
  'Configuración PCFD': { fn: 'Aplica una configuración base de torre PCFD.', tip: '2OP/4OP llenan gavetas, entrepaños y zócalo; después puedes editar cada valor.' },
  'Zócalo TK (in)': { fn: 'Altura del zócalo de la torre, siempre en pulgadas.', tip: 'CEMA usa 4.5 para TK4 y 5.25 para TK5.' },
